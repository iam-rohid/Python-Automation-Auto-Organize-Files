...
Dir = ""
Audios = ["mp3", "wav", "flac", "aac", "aa", "aax", "awb", "dvf", "ogg",
          "oga", "mpgg", "vox", "wma", "wv", "webm", "pcm", "ac3", "eac3"]
Videos = [".mkv", "mp4", "m4a", "m4v", "f4v", "f4a", "m4b", "m4r", "f4b", "mov", "3gp", "3gp2",
          "3g2", "3gpp", "3gpp2", "ogg", "oga", "ogv", "ogx", "wmv", "wma", "webm", "flv", "vob", "vob"]
...
def Button1(text):
    Button1 = tk.Button(frame, text=text, command=SelectFolder, bd=0, bg="#fff", padx=10, pady=5,
                        fg="#414141", font=("none", 12, "normal"), highlightcolor="#f1f1f1", state="normal")
    Button1.place(anchor="n", width=300, height=50, relx=0.5, y=150)


def Button2(text, state, command):
    Button2 = tk.Button(frame, text=text, command=command, bd=0, bg="#fff", padx=10, pady=5,
                        fg="#414141", font=("none", 12, "normal"), highlightcolor="#f1f1f1", state=state)
    Button2.place(anchor="n", width=300, height=50, relx=0.5, y=220)


def FileLinkText(text):
    FileLink = tk.Label(frame, text=text, font=(
        "none", 14), fg="#fff", bg=canvasColor)
...
HeaderText = tk.Label(frame, text="Organize Your Files", font=(
    "none", 20, "bold"), fg="#fff", bg=canvasColor)
...
# codsjnvklsnv;sdlvnkjsadv sanvias ijvas vjas v s v
